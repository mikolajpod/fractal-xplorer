...
inline int run_cli_selftest()
{
    ...
    const TestCase tests[] = {
        ...
        {"Perp. Mandelbrot",           FormulaType::PerpMandelbrot,  false, 2, 2.0, 0, FractalMode::EscapeTime, 0},
        {"Perp. Mandelbrot Julia",     FormulaType::PerpMandelbrot,  true,  2, 2.0, 0, FractalMode::EscapeTime, 0},
        {"Perp. Burning Ship",         FormulaType::PerpBurningShip, false, 2, 2.0, 0, FractalMode::EscapeTime, 0},
        {"Perp. Burning Ship Julia",   FormulaType::PerpBurningShip, true,  2, 2.0, 0, FractalMode::EscapeTime, 0},
        {"Perp. Celtic",               FormulaType::PerpCeltic,      false, 2, 2.0, 0, FractalMode::EscapeTime, 0},
        {"Perp. Celtic Julia",         FormulaType::PerpCeltic,      true,  2, 2.0, 0, FractalMode::EscapeTime, 0},
        {"Perp. Buffalo",              FormulaType::PerpBuffalo,     false, 2, 2.0, 0, FractalMode::EscapeTime, 0},
        {"Perp. Buffalo Julia",        FormulaType::PerpBuffalo,     true,  2, 2.0, 0, FractalMode::EscapeTime, 0},
        {"Perp. Mandelbrot lyap-full", FormulaType::PerpMandelbrot,  false, 2, 2.0, 2, FractalMode::EscapeTime, 0},
        {"Lambda",                     FormulaType::Lambda,          false, 2, 2.0, 0, FractalMode::EscapeTime, 0},
        {"Lambda Julia",               FormulaType::Lambda,          true,  2, 2.0, 0, FractalMode::EscapeTime, 0},
        {"Lambda lyap-full",           FormulaType::Lambda,          false, 2, 2.0, 2, FractalMode::EscapeTime, 0},
        // Lyapunov coloring
