...
inline int run_cli_benchmark()
{
    ...
    const TestCase tests[] = {
        ...
        {"Perp. Burning Ship",      FormulaType::PerpBurningShip, false, 2, 2.0, false, FractalMode::EscapeTime, 0},
        {"Lambda",                  FormulaType::Lambda,          false, 2, 2.0, false, FractalMode::EscapeTime, 0},
        ...
        {"Perp. Burning Ship",      FormulaType::PerpBurningShip, false, 2, 2.0, true,  FractalMode::EscapeTime, 0},
        {"Lambda",                  FormulaType::Lambda,          false, 2, 2.0, true,  FractalMode::EscapeTime, 0},
